...
import { runBatch } from "./agent.js"; // Asegúrate de que este archivo exista
import { canPublishNow, explainWindows } from "./services/scheduler.js"; // Asegúrate de que este archivo exista
...
// --- INICIO: CÓDIGO NUEVO ---
// Ruta raíz (/) para que el Health Check de EasyPanel funcione
app.get("/", (_req: Request, res: Response) => {
  res.status(200).json({ status: "ok", message: "Agent is running" });
});
// --- FIN: CÓDIGO NUEVO ---


const port = Number(process.env.PORT || 3000); // <-- CAMBIADO: 8080 a 3000 (el puerto que EasyPanel espera)
const host = "0.0.0.0";
